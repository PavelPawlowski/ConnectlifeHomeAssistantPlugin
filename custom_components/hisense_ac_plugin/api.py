        ...
        for lang in supported_langs:
            try:
                ...
                if lang == "zh-Hans":
                    ...
                    hass.data[f"{DOMAIN}.translations"][lang] = {
                        "indoor_temperature": "Vnitřní teplota",
                        "power_consumption": "Spotřeba energie",
                        "indoor_humidity": "Vnitřní vlhkost",
                        "in_water_temp": "Teplota vstupní vody",
                        "out_water_temp": "Teplota výstupní vody",
                        "f_zone1water_temp1": "Skutečná teplota zóny 1",
                        "f_zone2water_temp2": "Skutečná teplota zóny 2",
                        "f_e_intemp": "Porucha snímače vnitřní teploty",
                        "f_e_incoiltemp": "Porucha snímače teploty vnitřního výměníku",
                        "f_e_inhumidity": "Porucha snímače vnitřní vlhkosti",
                        "f_e_infanmotor": "Porucha motoru vnitřního ventilátoru",
                        "f_e_arkgrille": "Výstraha ochrany mřížky skříně",
                        "f_e_invzero": "Porucha detekce nulového napětí uvnitř",
                        "f_e_incom": "Porucha komunikace vnitřní-venkovní jednotky",
                        "f_e_indisplay": "Porucha komunikace displeje",
                        "f_e_inkeys": "Porucha komunikace klávesnice",
                        "f_e_inwifi": "Porucha komunikace WiFi desky",
                        "f_e_inele": "Porucha komunikace vnitřní napájecí desky",
                        "f_e_ineeprom": "Chyba vnitřní paměti EEPROM",
                        "f_e_outeeprom": "Chyba venkovní paměti EEPROM",
                        "f_e_outcoiltemp": "Porucha snímače teploty venkovního výměníku",
                        "f_e_outgastemp": "Porucha snímače výstupní teploty",
                        "f_e_outtemp": "Porucha snímače venkovní teploty",
                        "f_e_push": "Chyba push notifikace",
                        "f_e_waterfull": "Výstraha plné nádrže",
                        "f_e_upmachine": "Porucha horního vnitřního ventilátoru",
                        "f_e_dwmachine": "Porucha spodního venkovního ventilátoru",
                        "f_e_filterclean": "Výstraha čištění filtru",
                        "f_e_wetsensor": "Porucha vlhkostního senzoru",
                        "f_e_tubetemp": "Porucha snímače teploty trubky",
                        "f_e_temp": "Porucha snímače pokojové teploty",
                        "f_e_pump": "Porucha čerpadla",
                        "f_e_exhaust_hightemp": "Přehřátí výstupní teploty",
                        "f_e_high_pressure": "Porucha vysokého tlaku",
                        "f_e_low_pressure": "Porucha nízkého tlaku",
                        "f_e_wire_drive": "Porucha komunikace",
                        "f_e_coiltemp": "Porucha snímače teploty výměníku",
                        "f_e_env_temp": "Porucha snímače teploty prostředí",
                        "f_e_exhaust": "Porucha snímače výstupní teploty",
                        "f_e_inwater": "Porucha snímače teploty vstupní vody",
                        "f_e_water_tank": "Porucha snímače teploty nádrže",
                        "f_e_return_air": "Porucha snímače teploty vratného vzduchu",
                        "f_e_outwater": "Porucha snímače teploty výstupní vody",
                        "f_e_solar_temperature": "Porucha snímače solární teploty",
                        "f_e_compressor_overload": "Přetížení kompresoru",
                        "f_e_excessive_current": "Nadproud",
                        "f_e_fan_fault": "Porucha ventilátoru",
                        "f_e_displaycom_fault": "Porucha komunikace displeje",
                        "f_e_upwatertank_fault": "Porucha snímače horní nádrže",
                        "f_e_downwatertank_fault": "Porucha snímače spodní nádrže",
                        "f_e_suctiontemp_fault": "Porucha snímače sací teploty",
                        "f_e_e2data_fault": "Chyba dat EEPROM",
                        "f_e_drivecom_fault": "Porucha komunikace budicí desky",
                        "f_e_drive_fault": "Porucha budicí desky",
                        "f_e_returnwatertemp_fault": "Porucha snímače teploty vratné vody",
                        "f_e_clockchip_fault": "Porucha čipu hodin",
                        "f_e_eanode_fault": "Porucha anody",
                        "f_e_powermodule_fault": "Porucha napájecího modulu",
                        "f_e_fan_fault_tip": "Porucha venkovního ventilátoru",
                        "f_e_pressuresensor_fault_tip": "Porucha tlakového senzoru",
                        "f_e_tempfault_solarwater_tip": "Porucha snímače solární vody",
                        "f_e_tempfault_mixedwater_tip": "Porucha snímače smíšené vody",
                        "f_e_tempfault_balance_watertank_tip": "Porucha snímače vyrovnávací nádrže",
                        "f_e_tempfault_eheating_outlet_tip": "Porucha snímače výstupu elektrického ohřevu",
                        "f_e_tempfault_refrigerant_outlet_tip": "Porucha snímače výstupu chladiva",
                        "f_e_tempfault_refrigerant_inlet_tip": "Porucha snímače vstupu chladiva",
                        "f_e_inwaterpump_tip": "Porucha čerpadla",
                        "f_e_outeeprom_tip": "Porucha venkovní EEPROM",
                        "quiet_mode": "Tichý režim",
                        "rapid_mode": "Rychlé topení/chlazení",
                        "8heat_mode": "Režim 8heat",
                        "eco_mode": "Eco",
                        "fan_speed_自动": "Automatická rychlost",
                        "fan_speed_中风": "Střední",
                        "fan_speed_高风": "Vysoká",
                        "fan_speed_低风": "Nízká",
                        "t_zone1water_settemp1": "Nastavená teplota zóny 1",
                        "t_zone2water_settemp2": "Nastavená teplota zóny 2",
                        "STATE_CONTINUOUS": "Nepřetržitě",
                        "STATE_NORMAL": "Manuálně",
                        "STATE_AUTO": "Automaticky",
                        "STATE_DRY": "Sušení prádla",
                        "STATE_OFF": "Vypnuto",
                        "STATE_ELECTRIC": "Elektrický ohřev",
                        "STATE_DUAL_MODE": "Duální režim",
                        "STATE_DUAL_MODE_": "Boost",
                        "STATE_DUAL_1": "Rychlé",
                        "STATE_DUAL_1_": "Boost1",
                        "STATE_HEAT": "Topení",
                        "STATE_COOL": "Chlazení",
                        "STATE_HOT_WATER_COOL": "Chlazení + TUV",
                        "STATE_HOT_WATER_AUTO": "Automaticky + TUV",
                        "STATE_HOT_WATER": "Pouze TUV",
                        "STATE_HOT_WATER_HEAT": "Topení + TUV",
                        "fan_speed_ultra_low": "Velmi nízká",
                        "fan_speed_ultra_high": "Velmi vysoká",
                        "fan_speed_low": "Nízká",
                        "fan_speed_high": "Vysoká",
                    }
                else:
                    hass.data[f"{DOMAIN}.translations"][lang] = {
